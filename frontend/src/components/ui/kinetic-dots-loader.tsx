            ...
            <div className='flex gap-5'>
                {[...Array(dots)].map((_, i) => (
                    ...
                    >
                        ...
                        >
                            <div
                                className='w-full h-full rounded-full bg-gradient-to-b from-[#4ade80] to-[#22c55e] shadow-[0_0_15px_rgba(59,218,113,0.6)]'
                                style={{
                        ...
                        <div
                            className='absolute bottom-0 w-10 h-3 border border-[#3bda71]/30 rounded-[100%] opacity-0'
                            style={{
                        ...
                        {/* 3. REFLECTIVE SHADOW */}
                        <div
                            className='absolute -bottom-1 w-5 h-1.5 rounded-[100%] bg-[#3bda71]/40 blur-sm'
                            style={{
